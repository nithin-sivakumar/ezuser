...
/**
 * Authenticate a user by email and password and generate an authentication token.
 *
 ...
 */
async function loginByEmail(model, email, password) {
  try {
    if (!model) {
      console.error("🚨 At loginByEmail()");
      console.error(
